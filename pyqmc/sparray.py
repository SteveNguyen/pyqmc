...
Slightly modified by Steve N'Guyen steve.nguyen.000@gmail.com
...
class sparray(object):
    ...
    """
    def __init__(self, shape, default=0.0, dtype=float, data={}):
        ...
        self.dtype = dtype
        self.__data = data
        self.msize=int(numpy.prod(shape))
        # self.strides=tuple(int(prod(shape[i+1:])) for i in range(self.ndim))
